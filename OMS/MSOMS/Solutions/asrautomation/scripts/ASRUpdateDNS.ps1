<# 
    .DESCRIPTION 
        ...
        2. Change the vaule of TestDNSVMName with the name of the DNS Azure virtual machine created in test network
        3. Change the vaule of TestDNSVMRG with the name resource group of the DNS Azure virtual machine created in test network
        4. Change the vaule of ProdDNSVMName with the name of the DNS Azure virtual machine in your Azure production network
        5. Change the vaule of TestDNSVMRG with the name resource group of the DNS Azure virtual machine in your Azure production network
...
workflow UpdateDNSforFailedOverVMs
{
    param ( 
